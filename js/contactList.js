...
function loadContacts() {
    ...
    //ajax call retrieves data from web service via a HTTP GET communication protocol
    $.ajax({
        type: 'GET',
        url: 'http://contactlist.us-east-1.elasticbeanstalk.com/contacts',
        success: function(contactArray) {
                //jQuery .each function to run a for each loop through the contacts dataset.
